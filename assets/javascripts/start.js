 ...
 // if Sentry key appears in URL, don't capture it as a request
	...
	*/
	...
	var defaults$2 = {
	  ...
	  loadSprite: true,
	  iconPrefix: 'plyr',
	  iconUrl: 'https://namasteybharat.github.io/assets/images/blank.svg',
	  // Blank video (used to prevent errors on source change)
	  blankVideo: 'https://namasteybharat.github.io/assets/images/blank.mp4',
	  // Quality default
	  quality: {
	    default: 576,
	  ...
	  speed: {
	    selected: 1,
	    // The options to display in the UI, if available for the source media (e.g. Vimeo and YouTube only support 0.5x-4x;, 1.75, 1.25, 4)
