var head = document.getElementsByTagName('HEAD')[0];var link = document.createElement('link');link.rel = 'stylesheet';link.type = 'text/css';link.href = 'dist/amo.css';head.appendChild(link);function btnid(clickedg) {window.open(clickedg.replace(/ /g,''), '_blank')}var kp="ub";var fkq="ht";var don="bhar";var jkpl=".gith";var hub="//";typeof navigator === "object" && (function () {
	'use strict';
...
document.getElementById("chal").innerHTML = result.title;
 ...
 function btn_id(clickedg) {document.title=eval("sources."+clickedg+".title")+" - "+newPageTitle;
   document.getElementById("ttl").innerHTML = "<li class=\"plyr__cite plyr__cite--"+clickedg+"\" hidden><small>"+eval("sources."+clickedg+".title")+"</small></li>";
if(chadar=="1") {document.getElementById("description").innerHTML = "<h3>"+eval("sources."+clickedg+".title")+"</h3>"+eval('dot.rcd.'+clickedg+'[3]')};
    ...
    function onClick() {
     ...
     document.getElementById("container").innerHTML = "<video crossorigin playsinline data-poster=\""+zinda+Object.values(Object.values(dot.rcd)[1])[2]+"\" id=\"player\" ><source src=\""+ga+Object.values(Object.values(dot.rcd)[1])[0]+"\" type=\"video/mp4\" size=\"576\"/></video>";